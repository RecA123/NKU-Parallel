...
int main(int argc, char *argv[])
{
    ...
    // SQIndex sq_index;
    // build_sq_index(base, base_number, vecdim, sq_index);
    
    std::vector<float> pq_query_table;
    ...
    for(int i = 0; i < test_number; ++i) {
        ...
        //auto res = sq_search(sq_index, test_query + i*vecdim, base_number, k);

        auto res = flat_search_with_SQ(base, test_query + i*vecdim, base_number, vecdim, k);
